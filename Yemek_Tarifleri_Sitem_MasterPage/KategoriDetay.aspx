<%@ Page Title="" Language="C#" MasterPageFile="~/Kullanici.Master" AutoEventWireup="true" CodeBehind="KategoriDetay.aspx.cs" Inherits="Yemek_Tarifleri_Sitem_MasterPage.KategoriDetay" %>
        ...
        <table class="auto-style4">
            <tr>
                <td style="background-color: #FFFF99">
                    <asp:Label ID="Label8" runat="server" style="font-weight: 700; font-size: x-large; color: #FF5050" Text='<%# Eval("YemekAd") %>'></asp:Label>
                </td>
            </tr>
            <tr>
